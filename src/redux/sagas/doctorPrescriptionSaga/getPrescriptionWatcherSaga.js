...
import {
  errorGetPrescription,
  successGetPrescription,
} from '../../action/doctorPrescription/getPrescriptionAction';
...
export function* getPrescriptionWorkerSaga(data) {
  ...
  try {
    const response = yield call(
      getPrescriptionNetworkServices.getPrescription,
      payload,
    );
...
export function* getPrescriptionWatcherSaga() {
  yield takeLatest(
    getPrescription.getPrescriptionLoad,
    getPrescriptionWorkerSaga,
  );
}
