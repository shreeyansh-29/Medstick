...
import { errorDeleteNotification, successDeleteNotification } from "../../action/notification/deleteNotificationAction";
...
try
{
const response=yield call(notificationNetworkService.deleteNotification,payload)
...
export function* deleteNotificationWatcherSaga(){
    yield takeLatest(deleteNotification.deleteNotificationLoad,deleteNotificationWorkerSaga)
}