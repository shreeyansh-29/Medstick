...
const LeftStock = (props) => {
    ...
    const showAlert=()=>{
        Alert.alert('Warning','Stocks cannot be less then 0',[{
            text:'OK',
        }],
        {cancelable:false})
      }
  ...
  return (
    <View style={{flexDirection:'row',justifyContent:'center'}}>
      <TouchableOpacity onPress={()=> valueChangeMinus()} style={Styles.addbutton}>
      <Feather
                size={30}
                name="minus"
      ...
      <TextInput
            ...
            />
             <TouchableOpacity onPress={() => valueChangePlus()} style={Styles.addbutton}>
            <Feather
                size={30}
                name="plus"
                color={colorPalette.mainColor}
